...
, and no Graph-only equivalent is documented for this scenario's stated
...
aren't placed on hold unless you explicitly add them". A design that
...
- **Private channel resolution.** Private channel chats live in a dedicated mailbox separate from
 the parent Team's group mailbox, resolving *which* private channels
