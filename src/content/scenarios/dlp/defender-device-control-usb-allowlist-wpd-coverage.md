...
whoFor: "any buyer who has already deployed (or is deploying) the parent USB allowlist"
...
, and four new settings mirror the parent's group/rule pattern exactly, scoped
