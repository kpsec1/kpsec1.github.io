...
fullTitle: "DLP — Defender for Endpoint Device Control (macOS): Apple/Portable vendorId/productId Compound-Matched Device Allowlist"
category: "DLP"
categorySlug: "dlp"
...
`docs/licensing-matrix.md` §7 and `defender-device-control-usb-allowlist-macos-portable-device-
