...
whoFor: "any tenant that has already deployed (or is deploying via this library)"
...
Full licensing detail and citations: [Licensing matrix §2](/docs/licensing-matrix/#2-master-capability--license-matrix). Summary for this scenario
...
| Endpoint DLP (Devices) | **E5** | [Licensing matrix §2](/docs/licensing-matrix/#2-master-capability--license-matrix), DLP row |
...
| **Advanced classification scanning and protection** (Devices-specific) | Turned ON in Endpoint DLP settings | Required for Adaptive Protection to work on Devices at all, portal-only, no PowerShell/Graph toggle found during this build (see §5 Step 2 and §11) |
...
. This scenario's script does not create either action because no documented
...
- **No incremental license cost for a tenant already at E5/Suite for the feeder IRM policy and
 ...
 Protection/Endpoint DLP entitlement, not a separate SKU ([Licensing matrix §2](/docs/licensing-matrix/#2-master-capability--license-matrix)).
...
10. [Licensing matrix §2](/docs/licensing-matrix/#2-master-capability--license-matrix), Adaptive Protection and Endpoint DLP rows.
