...
narrower custom role group, per [RBAC model §6/§14](/docs/rbac-model/#6-exchange-online-dependency-the-most-common-permissions-gap)) was assigned to the service principal or
