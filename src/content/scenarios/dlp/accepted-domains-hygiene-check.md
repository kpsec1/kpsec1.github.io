...
fullTitle: "DLP — Accepted-Domains Hygiene Check"
category: "DLP"
categorySlug: "dlp"
...
|---|---|---|
| RBAC system | Exchange Online RBAC (`docs/rbac-model.md` §6), **not** a Purview role group | `Get-AcceptedDomain`/`Search-UnifiedAuditLog` are pure Exchange Online PowerShell cmdlets — no Purview portal role covers them. |
...
- Re-verify no licensing change has occurred for `Get-AcceptedDomain`/`Search-UnifiedAuditLog`
  specifically before a sales commitment — `docs/licensing-matrix.md` §6.
