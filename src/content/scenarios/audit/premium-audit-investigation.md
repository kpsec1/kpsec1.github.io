...
| Auth (this scenario) | `Connect-MgGraph -Scopes 'AuditLogsQuery.Read.All'` (delegated) or app-only certificate | Microsoft Graph PowerShell SDK, [Automation surface §3](/docs/automation-surface/#3-authentication-patterns-interactive-vs-unattended) |
...
. Exact bodies and Learn sources are in the script `.NOTES`.
...
. No Azure PAYG meter for running queries.
