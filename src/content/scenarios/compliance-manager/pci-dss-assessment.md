...
whoFor: "a security/compliance team responsible for an in-scope PCI cardholder data"
...
| Automation identity (audit-trail script only) | App registration or account holding the **View-Only Audit Logs** (or **Audit Logs**) Exchange Online role, plus `Exchange.ManageAsApp` | Same requirement as `assess-against-iso27001/README.md` §3, [RBAC model §6](/docs/rbac-model/#6-exchange-online-dependency-the-most-common-permissions-gap) and [Automation surface §3](/docs/automation-surface/#3-authentication-patterns-interactive-vs-unattended) |
...
- **Compliance Manager's regulation catalog lists two separate PCI DSS templates**, "PCI DSS
 ...
 is issued against. Select v4.0, see §5 step 5 and §10 for the cost
...
, identical caveat to `assess-against-iso27001/README.md` §11.
...
- **A high compliance score is not proof of compliance.** Microsoft's own FAQ states this
 explicitly, this repeats `assess-against-iso27001/README.md` §11's identical
