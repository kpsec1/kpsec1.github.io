...
whoFor: "any organization, regardless of where it is headquartered, that offers goods or"
...
. Unlike every other regulation this library's Compliance Manager scenarios cover
...
. Compliance Manager's EU GDPR premium template exists to give an
...
| Automation identity (audit-trail script only) | App registration or account holding the **View-Only Audit Logs** (or **Audit Logs**) Exchange Online role, plus `Exchange.ManageAsApp` | Same requirement as the four sibling scenarios, [RBAC model §6](/docs/rbac-model/#6-exchange-online-dependency-the-most-common-permissions-gap) and [Automation surface §3](/docs/automation-surface/#3-authentication-patterns-interactive-vs-unattended) |
| Prerequisite (not deployed by this scenario) | Reviewed Article 28 processor-agreement terms with Microsoft (Online Services Terms / Data Protection Addendum) and, for cross-border transfers, the Standard Contractual Clauses Microsoft incorporates into its Volume Licensing agreements | A contractual, not a technical, prerequisite, see §2, §11. This scenario does not create or track these agreements itself |
...
, and those signals sync to this assessment **regardless of which group it
...
. For actions mapped to **Data Subject Rights**, confirm the evidence
...
. Unlike HIPAA's specific 6-year documentation-retention citation, GDPR imposes
