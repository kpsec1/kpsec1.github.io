...
- **[Automation surface](/docs/automation-surface/)'s own routing table (§4) confirms this**, it lists a surface for
...
. This script's audit trail is therefore a record of explicit
 ...
 **April 30, 2024**, and every ISO/IEC 27001:2013 certificate had to **expire or be reissued**
 against:2022 by **October 31, 2025**. As of this build's date (2026-09-10),
...
3. **Microsoft's own certification has already moved.** The Office 365/Microsoft 365 ISO/IEC 27001
 ...
 ISO 27001:2022 Certificate (2024-2027)"**, Microsoft assesses its own cloud
