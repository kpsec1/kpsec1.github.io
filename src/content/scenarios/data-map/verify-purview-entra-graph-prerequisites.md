...
whoFor: "a data governance or security team already running"
...
capability, not a P1/P2 feature ([Licensing matrix §8](/docs/licensing-matrix/#8-adjacent-product-family-microsoft-entra-id-p2-conditional-access-risk-based-conditions), 9 cover the *paid* Entra add-ons this
...
| Automation identity for the Graph calls | App registration with the `RoleManagement.Read.Directory` application permission, admin-consented | Client-secret or certificate app-only OAuth2, see [Automation surface §3](/docs/automation-surface/#3-authentication-patterns-interactive-vs-unattended) |
...
[Automation surface §1](/docs/automation-surface/#1-five-automation-surfaces-not-one-read-this-first). Step 1 (building the CSV) is a one-time, out-of-band step this
...
10. Microsoft Graph PowerShell SDK authentication and throttling guidance, [Automation surface §3/§5](/docs/automation-surface/#3-authentication-patterns-interactive-vs-unattended).
