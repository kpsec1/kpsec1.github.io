...
|---|---|---|
| Deploy surface | Purview Data Map REST API (`Invoke-RestMethod`), per [Automation surface](/docs/automation-surface/) surface 4 | Same as both sibling scenarios, no PowerShell module or Graph equivalent exists for data source/scan objects themselves |
