...
whoFor: "a data governance or security team that has already run the base Azure SQL"
...
- **Every scan rule set change is audit-logged, so treat the change itself as security-relevant.**
 ...
 ([RBAC model §14](/docs/rbac-model/#14-how-scenarios-should-cite-rbac)'s "how scenarios should cite RBAC" pattern applies equally to audit
...
([Licensing matrix §1](/docs/licensing-matrix/#1-the-two-billing-models-read-this-first), 2). A narrower scan rule set may modestly reduce scan **compute**
