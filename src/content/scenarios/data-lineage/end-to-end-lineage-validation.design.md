...
| Deploy/validate role split | Data Curator (deploy) vs. Data Reader (validate) | Matches this repo's least-privilege convention for every scenario with a `validate/` script (`docs/rbac-model.md` Section 5) |
