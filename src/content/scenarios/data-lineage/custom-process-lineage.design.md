...
| Deploy/validate role split | Data Curator (deploy) vs. Data Reader (validate) | Matches this repo's least-privilege convention ([RBAC model](/docs/rbac-model/) Section 5) |
