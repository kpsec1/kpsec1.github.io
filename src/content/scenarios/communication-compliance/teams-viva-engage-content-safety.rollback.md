...
investigations and reviews. Use this stage for testing, troubleshooting a
...
- **This is permanent.** Deleting the policy **permanently deletes all captured messages,
 attachments, and alerts** it captured. Re-creating the policy means running the
...
- If the deactivation reason was the **storage/message limit** being reached rather than a
 ...
 deactivated one, for this scenario specifically, treat this as the default
