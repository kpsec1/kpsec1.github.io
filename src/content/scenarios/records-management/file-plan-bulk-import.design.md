...
| Path B descriptors | `New-FilePlanProperty*` create-or-report, then `-FilePlanProperty` JSON on the label | The documented PowerShell-native equivalent of the CSV's free-text descriptor columns [[1]](README.md#12-references) |
