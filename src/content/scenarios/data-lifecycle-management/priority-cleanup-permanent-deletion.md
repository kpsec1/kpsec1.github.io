...
surface: [Automation surface §3](/docs/automation-surface/#3-authentication-patterns-interactive-vs-unattended) (Security & Compliance PowerShell). This feature shares
...
|---|---|---|
| Tenant availability | Confirm the option is present before use | **Public preview rollout begins 2026-08-24**, Worldwide multi-tenant only is confirmed by this Learn page; **VERIFY (pilot tenant)** current availability and any GCC/GCC High/DoD timing difference before a customer-facing commitment (§11) |
