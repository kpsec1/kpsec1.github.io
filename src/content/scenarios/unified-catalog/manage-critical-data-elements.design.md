 ...
 **Entity** operation group and API version [Automation surface §4](/docs/automation-surface/#4-routing-table-which-surface-for-which-purview-task) already pins for
...
Map/Atlas API from the same script for the same object graph. [Automation surface §4](/docs/automation-surface/#4-routing-table-which-surface-for-which-purview-task)'s
