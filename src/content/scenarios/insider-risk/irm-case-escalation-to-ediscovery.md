...
whoFor: "an Insider Risk Management Investigator (or a legal/compliance team acting on"
frameworks: []
licensing: []
deployCount: 3
validateCount: 1
...
| Role to escalate an IRM case | **Insider Risk Management** or **Insider Risk Management Investigators** role group | The manual portal step this scenario starts after (§5); see [RBAC model §4](/docs/rbac-model/#4-purview-role-groups-by-module-representative-not-exhaustive) |
...
; an investigator who has just escalated can select **Automate** → the flow
...
; `Search-UnifiedAuditLog` (the mechanism this library's other audit-trail
