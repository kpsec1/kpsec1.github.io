...
whoFor: "an organization already running the parent Copilot DLP policy that wants to reduce"
frameworks: []
...
[Licensing matrix §2](/docs/licensing-matrix/#2-master-capability--license-matrix) (DSPM for AI rows), re-verify both against current Microsoft Learn
